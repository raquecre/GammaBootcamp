...
Podemos acceder a todos los números de teclas del teclado utilizando diferentes tipos de event listener. Usemos `keypress` y obtengamos el `code` de cada tecla del teclado.
